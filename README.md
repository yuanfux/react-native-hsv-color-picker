...
| `huePickerHue` | number  | `0` | hue value(`h` in `hsv`) for the hue picker. `Range [0, 360]`  |
...
| `satValPickerHue` | number  | `0` | hue value(`h` in `hsv`) for the saturation & value picker. `Range [0, 360]`  |
| `satValPickerSaturation` | number  | `1` | saturation value(`s` in `hsv`) for the saturation & value picker. `Range [0, 1]`  |
| `satValPickerValue` | number  | `1` | value(`v` in `hsv`) for the saturation & value picker. `Range [0, 1]`  |
